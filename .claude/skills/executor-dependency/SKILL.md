...
description: >
  ...
  [AI self-triggered] When Claude is writing code that requires async/concurrent/scheduled capability
...
### AI self-triggered (Claude proactively triggers when writing code, any of the following)
...
> When self-triggered, Claude **must** inform the user before output:  
...
**Source B (AI self-triggered)**: Claude identifies async/concurrent/scheduled need while writing code. Explain why the
